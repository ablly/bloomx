# production-realtime-admin-system Specification

## Purpose
Define the production operating standard for the BloomX admin console: live Firestore-backed datasets, isolated read failures, deterministic aggregation, and Activepieces-first workflow automation for merchant review, payments, support, settlement, health checks, and event routing.
## Requirements
